...
<?php $__env->startSection('title', 'Kelola Prestasi Siswa - Admin'); ?>
...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        ...
        <a href="<?php echo e(route('development.content.appreciations.create')); ?>" class="px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white rounded-xl text-xs font-bold transition">+ TAMBAH PRESTASI</a>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <?php $__empty_1 = true; $__currentLoopData = $appreciations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php $media = $item->appreciationMedia->first()?->mediaFile; ?>
            <div class="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-between space-y-3">
                ...
                <div class="pt-2 border-t flex justify-between items-center text-[10px]">
                    <span class="font-bold text-amber-600"><?php echo e($item->status); ?></span>
                    <form action="<?php echo e(route('development.content.appreciations.destroy', $item->id)); ?>" method="POST" onsubmit="return confirm('Hapus prestasi ini?')">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\website-pplg\resources\views/pages/development/public/content/appreciations/index.blade.php ENDPATH**/ ?>