...
<?php $__env->startSection('title', 'Tambah Karya Siswa - Admin'); ?>
...
<div class="max-w-2xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        ...
        <a href="<?php echo e(route('development.content.projects.index')); ?>" class="text-xs font-semibold text-slate-500 hover:text-slate-700 transition">← Kembali</a>
    </div>

    <form action="<?php echo e(route('development.content.projects.store')); ?>" method="POST" class="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-sm space-y-4">
        <?php echo csrf_field(); ?>

        <div class="space-y-1">
            <label class="block text-xs font-bold text-slate-700 uppercase tracking-wider">Judul Project *</label>
            <input type="text" name="title" required value="<?php echo e(old('title')); ?>" placeholder="Contoh: Aplikasi Kasir Gym / Website Portfolio" class="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-xs focus:outline-none focus:border-blue-600 transition">
        </div>
        ...
        <div class="space-y-1">
            ...
            <textarea name="description" rows="3" required placeholder="Jelaskan mengenai fitur, teknologi, dan keunggulan karya ini..." class="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-xs focus:outline-none focus:border-blue-600 transition"><?php echo e(old('description')); ?></textarea>
        </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\website-pplg\resources\views/pages/development/public/content/projects/create.blade.php ENDPATH**/ ?>