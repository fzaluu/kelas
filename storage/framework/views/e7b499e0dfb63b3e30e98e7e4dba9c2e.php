...
<div class="min-h-[75vh] flex items-center justify-center px-4 py-16 bg-gradient-to-b from-blue-50/50 via-white to-slate-50">
    <div class="max-w-lg w-full text-center space-y-6">
        ...
        <div class="pt-2 flex justify-center space-x-3">
            <a href="<?php echo e(route('home')); ?>" class="px-6 py-3 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs uppercase tracking-wider shadow-md shadow-blue-500/20 transition hover:scale-105 active:scale-95">
                ← Kembali ke Beranda
            </a>
        </div>
        <form action="<?php echo e(route('logout')); ?>" method="POST" class="inline">
        <?php echo csrf_field(); ?>
        <button type="submit" class="px-5 py-2.5 bg-rose-600 hover:bg-rose-700 text-white font-bold text-xs rounded-xl shadow-md transition">
            LOGOUT
        </button>
    </form>
    </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\website-pplg\resources\views/errors/403.blade.php ENDPATH**/ ?>