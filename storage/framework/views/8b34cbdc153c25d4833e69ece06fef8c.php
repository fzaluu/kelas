...
<?php $__env->startSection('title', 'Kontak Resmi - XI PPLG 2'); ?>
...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
    ...
    <div class="bg-white rounded-3xl p-8 sm:p-10 border border-slate-200 shadow-sm">
        ...
        <form action="<?php echo e(route('public.contact.submit')); ?>" method="POST" class="space-y-6 max-w-2xl">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\website-pplg\resources\views/pages/public/contact.blade.php ENDPATH**/ ?>