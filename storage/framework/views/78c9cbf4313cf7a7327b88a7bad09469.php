...
<?php $__env->startSection('title', 'Beranda Utama - XI PPLG 2'); ?>
...
<section class="relative bg-slate-900 text-white pt-12 pb-24 overflow-hidden">
    ...
    <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
        ...
        <div class="pt-4 flex justify-center items-center space-x-4">
            <a href="<?php echo e(route('public.about')); ?>" class="px-6 py-3.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs uppercase tracking-wider shadow-lg shadow-blue-600/30 transition hover:scale-105 active:scale-95">
                Jelajahi Profil Kelas →
            </a>
            <a href="<?php echo e(route('public.information.announcements')); ?>" class="px-6 py-3.5 rounded-xl bg-slate-800/80 hover:bg-slate-700 text-slate-200 border border-slate-700 font-bold text-xs uppercase tracking-wider transition hover:scale-105 active:scale-95 backdrop-blur-sm">
                Lihat Informasi
            </a>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div class="p-6 rounded-2xl bg-slate-50 border border-slate-100">
                <div class="text-3xl sm:text-4xl font-extrabold text-blue-600 mb-1"><?php echo e($totalMembers ?? 32); ?></div>
        ...
        <div class="bg-white rounded-3xl p-8 sm:p-12 border border-slate-200 shadow-sm flex flex-col md:flex-row items-center justify-between gap-8">
            <div class="space-y-4 max-w-2xl">
                ...
                <p class="text-sm sm:text-base text-slate-600 leading-relaxed">
                    <?php echo e($profile->vision ?? 'Fokus pada penguasaan pemrograman web, aplikasi mobile, basis data, dan pengembangan gim.'); ?>

                </p>
            </div>
            <div class="flex-shrink-0">
                <a href="<?php echo e(route('public.about')); ?>" class="inline-flex items-center px-6 py-3 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-semibold text-sm transition hover:scale-105 active:scale-95">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ann): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="bg-slate-50 rounded-2xl p-6 border border-slate-200 space-y-3">
                    <div class="flex justify-between items-center">
                        <span class="px-3 py-1 rounded-md text-[10px] font-bold bg-amber-100 text-amber-800 uppercase"><?php echo e($ann->priority); ?></span>
                        <span class="text-[11px] text-slate-400"><?php echo e(\Carbon\Carbon::parse($ann->published_at)->format('d M Y')); ?></span>
                    </div>
                    <h3 class="text-base font-bold text-slate-900 line-clamp-1"><?php echo e($ann->title); ?></h3>
                    <p class="text-xs text-slate-600 leading-relaxed line-clamp-2"><?php echo e(Str::limit(strip_tags($ann->content), 100)); ?></p>
                </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <?php $__empty_1 = true; $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="group relative h-48 rounded-2xl bg-slate-900 overflow-hidden border border-slate-200 shadow-sm">
                    <?php if(optional($gal->mediaFile)->url): ?>
                        <img src="<?php echo e($gal->mediaFile->url); ?>" class="w-full h-full object-cover group-hover:scale-105 transition duration-300">
                    <?php endif; ?>
                    ...
                    <div class="absolute bottom-3 left-3 right-3 z-20">
                        <span class="text-[10px] font-bold text-blue-400 uppercase tracking-wider block"><?php echo e($gal->category); ?></span>
                        <h4 class="text-xs font-bold text-white truncate"><?php echo e($gal->title); ?></h4>
...
<section id="projects" class="py-16 bg-white border-b border-slate-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <?php $__empty_1 = true; $__currentLoopData = $projects ?? $featuredProjects ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="bg-slate-50 rounded-3xl p-6 border border-slate-200 flex flex-col justify-between space-y-4">
                    <div>
                        ...
                        <h3 class="text-xl font-bold text-slate-900 mb-2"><?php echo e($proj->title); ?></h3>
                        <p class="text-xs text-slate-600 leading-relaxed line-clamp-3"><?php echo e($proj->description); ?></p>
                    </div>
                    <div class="pt-4 border-t border-slate-200 text-xs font-medium text-slate-500 flex justify-between items-center">
                        <span>Tim: <?php echo e(optional($proj->members)->count() ?? 1); ?> Anggota</span>
...
<section class="py-16 bg-slate-50 border-b border-slate-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <?php $__empty_1 = true; $__currentLoopData = $appreciations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="bg-white p-6 rounded-2xl border border-slate-200 flex items-center space-x-4 shadow-sm">
                    ...
                    <div>
                        <h4 class="font-bold text-slate-900 text-sm"><?php echo e($app->title); ?></h4>
                        <p class="text-xs text-slate-500"><?php echo e($app->description); ?></p>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="col-span-2 text-center py-8 text-xs text-slate-400 border border-dashed border-slate-200 rounded-2xl">
...
<section class="py-16 bg-white border-b border-slate-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-end mb-10">
            ...
            <a href="<?php echo e(route('public.about')); ?>#members" class="text-xs font-bold text-blue-600 hover:underline">Lihat Semua Siswa →</a>
        </div>

        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
            <?php $__empty_1 = true; $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="bg-slate-50 p-4 rounded-2xl border border-slate-100 text-center">
                    <div class="w-14 h-14 rounded-full bg-blue-100 text-blue-700 font-bold flex items-center justify-center mx-auto mb-3 text-base uppercase">
                        <?php echo e(substr($mb->name, 0, 2)); ?>

                    </div>
                    <h4 class="font-bold text-xs text-slate-900 truncate"><?php echo e($mb->name); ?></h4>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\website-pplg\resources\views/pages/public/home.blade.php ENDPATH**/ ?>