...
<body class="bg-gradient-to-br from-blue-50/70 via-slate-100 to-indigo-50/60 min-h-screen flex items-center justify-center p-4 sm:p-6 antialiased font-sans">
    ...
    <div class="relative z-10 w-full max-w-md bg-white p-6 sm:p-8 rounded-3xl shadow-xl border border-slate-200/80 space-y-5">
        ...
        <div class="flex justify-between items-center">
            <a href="<?php echo e(route('login')); ?>" class="text-xs font-semibold text-slate-400 hover:text-blue-600 transition flex items-center space-x-1">
        ...
        <form action="<?php echo e(route('register.post')); ?>" method="POST" class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-3">
                <div class="space-y-1">
                    ...
                    <input type="text" name="nis" value="<?php echo e(old('nis')); ?>" placeholder="Contoh: 22231001" class="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 bg-slate-50/50 text-xs focus:bg-white focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20 transition" required>
                    <?php $__errorArgs = ['nis'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="space-y-1">
                ...
                <input type="text" name="full_name" value="<?php echo e(old('full_name')); ?>" placeholder="Nama siswa" class="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 bg-slate-50/50 text-xs focus:bg-white focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20 transition" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="space-y-1">
                ...
                <input type="text" name="username" value="<?php echo e(old('username')); ?>" placeholder="Username login" class="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 bg-slate-50/50 text-xs focus:bg-white focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20 transition" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="space-y-1">
                ...
                <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="email@smkn4tasikmalaya.sch.id" class="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 bg-slate-50/50 text-xs focus:bg-white focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20 transition" required>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="text-center pt-3 border-t border-slate-100 space-y-1">
            <p class="text-xs text-slate-500">
                Sudah punya akun? 
                <a href="<?php echo e(route('login')); ?>" class="font-bold text-blue-600 hover:underline">Masuk Login</a>
            </p>
        </div>
...
</html><?php /**PATH C:\laragon\www\website-pplg\resources\views/pages/auth/register.blade.php ENDPATH**/ ?>