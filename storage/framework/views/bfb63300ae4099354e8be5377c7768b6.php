...
<a href="<?php echo e(route('development.public.announcements.index')); ?>" 
   class="flex items-center px-4 py-2.5 rounded-xl font-medium <?php echo e(request()->routeIs('development.public.announcements.*') ? 'bg-blue-600 text-white shadow-md' : 'text-slate-400 hover:bg-slate-800 hover:text-white'); ?> transition">
