...
<?php $__env->startSection('title', 'Developer Overview'); ?>
...
<div class="space-y-6">
    ...
    <div class="p-6 sm:p-8 rounded-3xl bg-gradient-to-r from-blue-700 via-blue-600 to-indigo-700 text-white shadow-xl shadow-blue-600/15 relative overflow-hidden">
        ...
        <div class="relative z-10 space-y-2">
            ...
            <h1 class="text-2xl sm:text-3xl font-extrabold tracking-tight">Halo, <?php echo e(Auth::user()->name ?? Auth::user()->username); ?>! 👋</h1>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        <div class="p-5 rounded-2xl bg-white border border-slate-200/80 shadow-sm space-y-3">
            ...
            <div>
                <p class="text-xl font-black text-slate-900"><?php echo e($totalUsers ?? 1); ?> User</p>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\website-pplg\resources\views/pages/development/dashboard.blade.php ENDPATH**/ ?>