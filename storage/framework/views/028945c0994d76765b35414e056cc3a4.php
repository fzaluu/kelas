...
<div class="space-y-6">
    ...
    <div class="flex items-center space-x-2 border-b border-slate-200 overflow-x-auto pb-2">
        <a href="<?php echo e(route('development.public.announcements.index')); ?>" class="px-4 py-2 rounded-xl text-xs font-semibold text-slate-500 hover:bg-slate-100 transition">Pengumuman</a>
        <a href="<?php echo e(route('development.public.agendas.index')); ?>" class="px-4 py-2 rounded-xl text-xs font-bold bg-blue-600 text-white shadow-sm">Agenda</a>
