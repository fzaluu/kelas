...
@section('title', 'Kelola Galeri & Konten - XI PPLG 2')

@section('content')
<div class="space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl font-extrabold text-slate-900 tracking-tight">Galeri Kegiatan, Karya & Prestasi</h1>
            <p class="text-xs text-slate-500">Kelola dokumentasi visual kegiatan, proyek karya siswa, dan apresiasi XI PPLG 2.</p>
        </div>
