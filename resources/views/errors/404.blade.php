...
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan — Website Kelas PPLG</title>
...
<body>
    <div class="error-wrapper">
        <div class="error-card">
            <div class="error-badge" style="background:var(--color-brand-primary-light); color:var(--color-brand-primary);">404</div>
            <h1 class="error-title">Halaman Tidak Ditemukan</h1>
            <p class="error-desc">Tautan yang Anda tuju tidak ada, telah dipindahkan, atau alamat URL yang dimasukkan salah.</p>
