...
<head>
    ...
    <title>419 - Sesi Halaman Kadaluarsa — Website Kelas PPLG</title>
...
<body>
    <div class="error-wrapper">
        <div class="error-card">
            <div class="error-badge" style="background:var(--color-surface-sunken); color:var(--color-text-secondary);">419</div>
            <h1 class="error-title">Sesi Halaman Kadaluarsa</h1>
            <p class="error-desc">Sesi keamanan formulir Anda telah berakhir karena tidak ada aktivitas. Silakan muat ulang halaman lalu coba lagi.</p>
            <div class="error-actions">
                <button type="button" class="btn btn-primary" onclick="window.location.reload()">&#8635; Muat Ulang</button>
                <button type="button" class="btn btn-secondary" onclick="pplgGoBack()">&larr; Kembali</button>
            </div>
