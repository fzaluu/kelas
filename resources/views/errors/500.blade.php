...
<head>
    ...
    <title>500 - Terjadi Masalah Sistem — Website Kelas PPLG</title>
...
<body>
    <div class="error-wrapper">
        <div class="error-card">
            <div class="error-badge" style="background:var(--color-feedback-danger-soft); color:var(--color-feedback-danger);">500</div>
            <h1 class="error-title">Terjadi Masalah Sistem</h1>
            <p class="error-desc">Server sedang mengalami gangguan internal. Tim pengembang kelas sedang berupaya menanganinya.</p>
