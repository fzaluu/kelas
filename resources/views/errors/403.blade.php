...
<head>
    ...
    <title>403 - Akses Ditolak — Website Kelas PPLG</title>
...
<body>
    <div class="error-wrapper">
        <div class="error-card">
            <div class="error-badge" style="background:var(--color-feedback-warning-soft); color:var(--color-feedback-warning);">403</div>
            <h1 class="error-title">Akses Ditolak</h1>
            <p class="error-desc">Anda tidak memiliki hak akses atau izin yang sesuai untuk membuka halaman ini.</p>
